...
class HomeAssistant extends BaseExtension {
    ...
    discover(device, mappedModel, force=false) {
        ...
        this.getConfigs(mappedModel).forEach((config) => {
            ...
            // Set unique_id
            payload.unique_id = `${entity.ID}_${config.object_id}_wirenboard`;
            ...
            if (settings.get().advanced.availability_timeout) {
                payload.availability_topic = `${settings.get().mqtt.base_topic}/${entity.friendlyName}/controls/availability`;
            } else {
