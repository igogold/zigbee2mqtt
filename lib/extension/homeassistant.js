    ...
    discover(resolvedEntity, force=false) {
        ...
        this.getConfigs(resolvedEntity).forEach((config) => {
            ...
            if (settings.get().advanced.availability_timeout) {
                payload.availability_topic = `${settings.get().mqtt.base_topic}/${friendlyName}/controls/availability`;
            } else {
                payload.availability_topic = `${settings.get().mqtt.base_topic}/bridge/controls/state`;
            }
